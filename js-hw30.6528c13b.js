...
const intervalId = setInterval(()=>{
    message += 1;
    textRef.textContent = `\u{41F}\u{43E}\u{432}\u{456}\u{434}\u{43E}\u{43C}\u{43B}\u{435}\u{43D}\u{43D}\u{44F} ${message}`;
    if (message === 5) clearInterval(intervalId);
}, 2000);
...
function endGame() {
    ...
    } else timerRef.textContent = `Game Over! Best: ${highScore}`;
}
function resetGame() {
    score = 0;
    clicks = 0;
...
},{}]},["6DHTQ","6kb64"], "6kb64", "parcelRequire271d", {})

//# sourceMappingURL=js-hw30.6528c13b.js.map
